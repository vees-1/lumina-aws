...
export default function HowItWorksPage() {
  const t = useTranslations("hpoWorkflow");
  ...
  return (
    <div className="min-h-screen bg-[#F7F8FA] font-sans text-slate-900">
      ...
      {/* Hero Section */}
      <section className="bg-slate-900 px-6 py-20 text-center text-white lg:px-8 lg:py-28 shadow-inner">
        <h1 className="mb-6 text-3xl font-normal lg:text-5xl">
          {t("heroTitle")}
        </h1>
        <p className="mx-auto max-w-3xl text-base leading-relaxed text-cyan-200 lg:text-lg">
